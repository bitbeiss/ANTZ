...
Area * Ameise::checkFoodSourrounding() {
...
//FALL 2: WIR SUCHEN NOCH FUTTER-------------------------------------------------------------------------------------------------------------------
		...
		//Der backtrack_stack ist leer (Ameise will losgehen)
...
//TO DO: Alle umgebenden Felder auf Futter überprüfen mittels bereits fertiggestellter Funktion: Area* checkFoodSourrounding();
//Rückgabe bei gefundenem Futter: Area*, Rückgabe wenn nichts gefunden: nullptr


//todo: Würfel für start/Ameisenhügel (alle Richtungen gleich wahrscheinlich)
		...
		//toDo: erster move muss ohne provenience erfolgen! (wenn stack size = 1)
